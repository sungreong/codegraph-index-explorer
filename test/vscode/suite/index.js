...
async function run() {
  ...
  assert.ok(commands.includes("codegraph.copySetupPrompt"), "setup prompt command should be registered");
  assert.ok(commands.includes("codegraph.openSetupGuide"), "setup guide command should be registered");
