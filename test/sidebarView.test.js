...
assert.match(html, /Choose destinations for bundled Codegraph skills/);
...
assert.match(html, /Copy setup prompt for an agent/);
assert.match(html, /Open colbymchenry\/codegraph/);
assert.match(html, /copySetupPrompt/);
assert.match(html, /openSetupGuide/);
